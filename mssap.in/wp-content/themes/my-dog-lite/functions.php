...
define('MY_DOG_LITE_SKTTHEMES_URL','https://www.sktthemes.org');
define('MY_DOG_LITE_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.org/shop/dog-wordpress-theme/');
define('MY_DOG_LITE_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.org/shop/free-pet-wordpress-theme/');
define('MY_DOG_LITE_SKTTHEMES_THEME_DOC','http://sktthemesdemo.net/documentation/my-dog-documentation/');
define('MY_DOG_LITE_SKTTHEMES_LIVE_DEMO','https://sktperfectdemo.com/demos/mydog/');
define('MY_DOG_LITE_SKTTHEMES_THEMES','https://www.sktthemes.org/themes/');
/**
...
add_action( 'tgmpa_register', 'my_dog_lite_register_required_plugins' );
 
function my_dog_lite_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'SKT Templates',
			'slug'      => 'skt-templates',

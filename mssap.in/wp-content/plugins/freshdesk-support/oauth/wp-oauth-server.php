...
function wpoauth_server_register_query_vars() {
	wpoauth_server_register_rewrites();
 ...
 * @return void
 */
function wpoauth_server_register_rewrites() {
...
global $wp_version;
if ( $wp_version <= 4.3 ) {
	function wpoauth_incompatibility_with_wp_version() {
		?>
	...
	add_action( 'admin_notices', 'wpoauth_incompatibility_with_wp_version' );
}
